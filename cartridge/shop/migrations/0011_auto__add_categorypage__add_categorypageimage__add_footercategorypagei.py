...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CategoryPage'
        db.create_table('shop_categorypage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Category'], unique=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('status', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('publish_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('expiry_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('just_arrived', self.gf('django.db.models.fields.related.ForeignKey')(related_name='catergorypage_just_arrived_set', to=orm['shop.Category'])),
        ))
        db.send_create_signal('shop', ['CategoryPage'])

        # Adding model 'CategoryPageImage'
        db.create_table('shop_categorypageimage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('panel', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.CategoryPage'])),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('alt_text', self.gf('django.db.models.fields.CharField')(max_length=140, blank=True)),
            ('link', self.gf('django.db.models.fields.URLField')(max_length=160, blank=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('active', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('publish_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('expiry_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
        ))
        db.send_create_signal('shop', ['CategoryPageImage'])

        # Adding model 'FooterCategoryPageImage'
        db.create_table('shop_footercategorypageimage', (
            ('categorypageimage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.CategoryPageImage'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('shop', ['FooterCategoryPageImage'])

        # Adding model 'SecondaryCategoryPageImage'
        db.create_table('shop_secondarycategorypageimage', (
            ('categorypageimage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.CategoryPageImage'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('shop', ['SecondaryCategoryPageImage'])

        # Adding model 'ShippingOption'
        db.create_table('shop_shippingoption', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal('shop', ['ShippingOption'])

        # Adding M2M table for field countries on 'ShippingOption'
        db.create_table('shop_shippingoption_countries', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('shippingoption', models.ForeignKey(orm['shop.shippingoption'], null=False)),
            ('country', models.ForeignKey(orm['countries.country'], null=False))
        ))
        db.create_unique('shop_shippingoption_countries', ['shippingoption_id', 'country_id'])

        # Adding model 'PrimaryCategoryPageImage'
        db.create_table('shop_primarycategorypageimage', (
            ('categorypageimage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.CategoryPageImage'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('shop', ['PrimaryCategoryPageImage'])

        # Adding field 'CartItem._unit_price_myr'
        db.add_column('shop_cartitem', '_unit_price_myr',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'CartItem._unit_price_sgd'
        db.add_column('shop_cartitem', '_unit_price_sgd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'CartItem._unit_price_hkd'
        db.add_column('shop_cartitem', '_unit_price_hkd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ProductOption.display_name'
        db.add_column('shop_productoption', 'display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'ProductOption.ranking'
        db.add_column('shop_productoption', 'ranking',
                      self.gf('django.db.models.fields.IntegerField')(default=100),
                      keep_default=False)

        # Adding field 'ProductVariation._unit_price_myr'
        db.add_column('shop_productvariation', '_unit_price_myr',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ProductVariation._sale_price_myr'
        db.add_column('shop_productvariation', '_sale_price_myr',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ProductVariation._was_price_myr'
        db.add_column('shop_productvariation', '_was_price_myr',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ProductVariation._unit_price_sgd'
        db.add_column('shop_productvariation', '_unit_price_sgd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ProductVariation._sale_price_sgd'
        db.add_column('shop_productvariation', '_sale_price_sgd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ProductVariation._was_price_sgd'
        db.add_column('shop_productvariation', '_was_price_sgd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ProductVariation._unit_price_hkd'
        db.add_column('shop_productvariation', '_unit_price_hkd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ProductVariation._sale_price_hkd'
        db.add_column('shop_productvariation', '_sale_price_hkd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ProductVariation._was_price_hkd'
        db.add_column('shop_productvariation', '_was_price_hkd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'ProductVariation.num_in_stock_pool'
        db.add_column('shop_productvariation', 'num_in_stock_pool',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Order.currency'
        db.add_column('shop_order', 'currency',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.rms_order_id'
        db.add_column('shop_order', 'rms_order_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'Order.has_rms_order_id'
        db.add_column('shop_order', 'has_rms_order_id',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Order.rms_customer_id'
        db.add_column('shop_order', 'rms_customer_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=60, blank=True),
                      keep_default=False)

        # Adding field 'Order.rms_message'
        db.add_column('shop_order', 'rms_message',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Order.rms_last_submitted'
        db.add_column('shop_order', 'rms_last_submitted',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Order.payment_gateway_transaction_id'
        db.add_column('shop_order', 'payment_gateway_transaction_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)

        # Adding field 'Order.payment_gateway_transaction_type'
        db.add_column('shop_order', 'payment_gateway_transaction_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=80, blank=True),
                      keep_default=False)

        # Adding field 'Product._unit_price_myr'
        db.add_column('shop_product', '_unit_price_myr',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product._sale_price_myr'
        db.add_column('shop_product', '_sale_price_myr',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product._was_price_myr'
        db.add_column('shop_product', '_was_price_myr',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product._unit_price_sgd'
        db.add_column('shop_product', '_unit_price_sgd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product._sale_price_sgd'
        db.add_column('shop_product', '_sale_price_sgd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product._was_price_sgd'
        db.add_column('shop_product', '_was_price_sgd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product._unit_price_hkd'
        db.add_column('shop_product', '_unit_price_hkd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product._sale_price_hkd'
        db.add_column('shop_product', '_sale_price_hkd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product._was_price_hkd'
        db.add_column('shop_product', '_was_price_hkd',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Product.master_item_code'
        db.add_column('shop_product', 'master_item_code',
                      self.gf('django.db.models.fields.CharField')(default='xxxxxxxxxx', unique=True, max_length=64),
                      keep_default=False)

        # Adding field 'Product.featured'
        db.add_column('shop_product', 'featured',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.in_stock'
        db.add_column('shop_product', 'in_stock',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.ranking'
        db.add_column('shop_product', 'ranking',
                      self.gf('django.db.models.fields.IntegerField')(default=500),
                      keep_default=False)

        # Adding field 'Cart.currency'
        db.add_column('shop_cart', 'currency',
                      self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True),
                      keep_default=False)

        # Adding field 'DiscountCode.allowed_no_of_uses'
        db.add_column('shop_discountcode', 'allowed_no_of_uses',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'DiscountCode.no_of_times_used'
        db.add_column('shop_discountcode', 'no_of_times_used',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding M2M table for field shipping_restriction on 'DiscountCode'
        db.create_table('shop_discountcode_shipping_restriction', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('discountcode', models.ForeignKey(orm['shop.discountcode'], null=False)),
            ('shippingoption', models.ForeignKey(orm['shop.shippingoption'], null=False))
        ))
        db.create_unique('shop_discountcode_shipping_restriction', ['discountcode_id', 'shippingoption_id'])

    def backwards(self, orm):
        # Deleting model 'CategoryPage'
        db.delete_table('shop_categorypage')

        # Deleting model 'CategoryPageImage'
        db.delete_table('shop_categorypageimage')

        # Deleting model 'FooterCategoryPageImage'
        db.delete_table('shop_footercategorypageimage')

        # Deleting model 'SecondaryCategoryPageImage'
        db.delete_table('shop_secondarycategorypageimage')

        # Deleting model 'ShippingOption'
        db.delete_table('shop_shippingoption')

        # Removing M2M table for field countries on 'ShippingOption'
        db.delete_table('shop_shippingoption_countries')

        # Deleting model 'PrimaryCategoryPageImage'
        db.delete_table('shop_primarycategorypageimage')

        # Deleting field 'CartItem._unit_price_myr'
        db.delete_column('shop_cartitem', '_unit_price_myr')

        # Deleting field 'CartItem._unit_price_sgd'
        db.delete_column('shop_cartitem', '_unit_price_sgd')

        # Deleting field 'CartItem._unit_price_hkd'
        db.delete_column('shop_cartitem', '_unit_price_hkd')

        # Deleting field 'ProductOption.display_name'
        db.delete_column('shop_productoption', 'display_name')

        # Deleting field 'ProductOption.ranking'
        db.delete_column('shop_productoption', 'ranking')

        # Deleting field 'ProductVariation._unit_price_myr'
        db.delete_column('shop_productvariation', '_unit_price_myr')

        # Deleting field 'ProductVariation._sale_price_myr'
        db.delete_column('shop_productvariation', '_sale_price_myr')

        # Deleting field 'ProductVariation._was_price_myr'
        db.delete_column('shop_productvariation', '_was_price_myr')

        # Deleting field 'ProductVariation._unit_price_sgd'
        db.delete_column('shop_productvariation', '_unit_price_sgd')

        # Deleting field 'ProductVariation._sale_price_sgd'
        db.delete_column('shop_productvariation', '_sale_price_sgd')

        # Deleting field 'ProductVariation._was_price_sgd'
        db.delete_column('shop_productvariation', '_was_price_sgd')

        # Deleting field 'ProductVariation._unit_price_hkd'
        db.delete_column('shop_productvariation', '_unit_price_hkd')

        # Deleting field 'ProductVariation._sale_price_hkd'
        db.delete_column('shop_productvariation', '_sale_price_hkd')

        # Deleting field 'ProductVariation._was_price_hkd'
        db.delete_column('shop_productvariation', '_was_price_hkd')

        # Deleting field 'ProductVariation.num_in_stock_pool'
        db.delete_column('shop_productvariation', 'num_in_stock_pool')

        # Deleting field 'Order.currency'
        db.delete_column('shop_order', 'currency')

        # Deleting field 'Order.rms_order_id'
        db.delete_column('shop_order', 'rms_order_id')

        # Deleting field 'Order.has_rms_order_id'
        db.delete_column('shop_order', 'has_rms_order_id')

        # Deleting field 'Order.rms_customer_id'
        db.delete_column('shop_order', 'rms_customer_id')

        # Deleting field 'Order.rms_message'
        db.delete_column('shop_order', 'rms_message')

        # Deleting field 'Order.rms_last_submitted'
        db.delete_column('shop_order', 'rms_last_submitted')

        # Deleting field 'Order.payment_gateway_transaction_id'
        db.delete_column('shop_order', 'payment_gateway_transaction_id')

        # Deleting field 'Order.payment_gateway_transaction_type'
        db.delete_column('shop_order', 'payment_gateway_transaction_type')

        # Deleting field 'Product._unit_price_myr'
        db.delete_column('shop_product', '_unit_price_myr')

        # Deleting field 'Product._sale_price_myr'
        db.delete_column('shop_product', '_sale_price_myr')

        # Deleting field 'Product._was_price_myr'
        db.delete_column('shop_product', '_was_price_myr')

        # Deleting field 'Product._unit_price_sgd'
        db.delete_column('shop_product', '_unit_price_sgd')

        # Deleting field 'Product._sale_price_sgd'
        db.delete_column('shop_product', '_sale_price_sgd')

        # Deleting field 'Product._was_price_sgd'
        db.delete_column('shop_product', '_was_price_sgd')

        # Deleting field 'Product._unit_price_hkd'
        db.delete_column('shop_product', '_unit_price_hkd')

        # Deleting field 'Product._sale_price_hkd'
        db.delete_column('shop_product', '_sale_price_hkd')

        # Deleting field 'Product._was_price_hkd'
        db.delete_column('shop_product', '_was_price_hkd')

        # Deleting field 'Product.master_item_code'
        db.delete_column('shop_product', 'master_item_code')

        # Deleting field 'Product.featured'
        db.delete_column('shop_product', 'featured')

        # Deleting field 'Product.in_stock'
        db.delete_column('shop_product', 'in_stock')

        # Deleting field 'Product.ranking'
        db.delete_column('shop_product', 'ranking')

        # Deleting field 'Cart.currency'
        db.delete_column('shop_cart', 'currency')

        # Deleting field 'DiscountCode.allowed_no_of_uses'
        db.delete_column('shop_discountcode', 'allowed_no_of_uses')

        # Deleting field 'DiscountCode.no_of_times_used'
        db.delete_column('shop_discountcode', 'no_of_times_used')

        # Removing M2M table for field shipping_restriction on 'DiscountCode'
        db.delete_table('shop_discountcode_shipping_restriction')
    ...
    models = {
        ...
        'shop.cartitem': {
            ...
            '_unit_price_hkd': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            '_unit_price_myr': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            '_unit_price_sgd': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
        ...
        'shop.categorypageimage': {
            ...
            'panel': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['shop.CategoryPage']"}),
            'publish_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        },
        'shop.discountcode': {
        ...
        'shop.product': {
            ...
            '_sale_price_hkd': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            '_sale_price_myr': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            '_sale_price_sgd': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            '_unit_price_hkd': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            '_unit_price_myr': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            '_unit_price_sgd': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            '_was_price_hkd': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            '_was_price_myr': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            '_was_price_sgd': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
