...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Order.billing_detail_street2'
        db.add_column('shop_order', 'billing_detail_street2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)

        # Adding field 'Order.shipping_detail_street2'
        db.add_column('shop_order', 'shipping_detail_street2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32),
                      keep_default=False)


        # Changing field 'Order.billing_detail_street'
        db.alter_column('shop_order', 'billing_detail_street', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Order.billing_detail_state'
        db.alter_column('shop_order', 'billing_detail_state', self.gf('django.db.models.fields.CharField')(max_length=12))

        # Changing field 'Order.shipping_detail_street'
        db.alter_column('shop_order', 'shipping_detail_street', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Order.shipping_detail_state'
        db.alter_column('shop_order', 'shipping_detail_state', self.gf('django.db.models.fields.CharField')(max_length=12))
    def backwards(self, orm):
        # Deleting field 'Order.billing_detail_street2'
        db.delete_column('shop_order', 'billing_detail_street2')

        # Deleting field 'Order.shipping_detail_street2'
        db.delete_column('shop_order', 'shipping_detail_street2')


        # Changing field 'Order.billing_detail_street'
        db.alter_column('shop_order', 'billing_detail_street', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Order.billing_detail_state'
        db.alter_column('shop_order', 'billing_detail_state', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Order.shipping_detail_street'
        db.alter_column('shop_order', 'shipping_detail_street', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Order.shipping_detail_state'
        db.alter_column('shop_order', 'shipping_detail_state', self.gf('django.db.models.fields.CharField')(max_length=100))
    models = {
        ...
        'shop.order': {
            ...
            'billing_detail_street2': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32'}),
            'currency': ('django.db.models.fields.CharField', [], {'max_length': '6', 'null': 'True', 'blank': 'True'}),
            ...
            'shipping_detail_street2': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '32'}),
