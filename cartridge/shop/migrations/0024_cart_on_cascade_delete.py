...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.execute('alter table shop_cartitem drop foreign key cart_id_refs_id_71757dfe')
        db.execute('alter table shop_cartitem add constraint shop_cart_fk foreign key (`cart_id`) references shop_cart(`id`) on delete cascade')

    def backwards(self, orm):
        db.execute('alter table shop_cartitem drop foreign key shop_cart_fk')
        db.execute('alter table shop_cartitem add constraint cart_id_refs_id_71757dfe foreign key (`cart_id`) references shop_cart(`id`)')
