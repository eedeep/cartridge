...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.date_price_last_modified'
        db.add_column('shop_product', 'date_price_last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Product.date_price_last_modified'
        db.delete_column('shop_product', 'date_price_last_modified')
    ...
    models = {
        ...
        'pages.page': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'to': "orm['pages.Page']", 'null': 'True', 'blank': 'True'}),
        ...
        'rdws.rmsorganisationunit': {
            'Meta': {'unique_together': "(('code', 'parent'),)", 'object_name': 'RmsOrganisationUnit'},
        ...
        'shop.product': {
            ...
            'date_price_last_modified': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
