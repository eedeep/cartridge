...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BundleDiscount.upsell_product'
        db.add_column('shop_bundlediscount', 'upsell_product',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'BundleDiscount.upsell_product'
        db.delete_column('shop_bundlediscount', 'upsell_product')
