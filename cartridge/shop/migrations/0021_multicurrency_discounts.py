...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for currency in settings.STORE_CONFIGS:
            db.add_column('shop_discountcode', '_min_purchase_{}'.format(currency.lower()),
                          self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

            db.add_column('shop_discountcode', '_discount_deduct_{}'.format(currency.lower()),
                          self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                          keep_default=False)

            db.add_column('shop_discountcode', '_discount_exact_{}'.format(currency.lower()),
                          self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                          keep_default=False)

    def backwards(self, orm):
        for currency in settings.STORE_CONFIGS:
            db.delete_column('shop_discountcode', '_min_purchase_{}'.format(currency.lower()))
            db.delete_column('shop_discountcode', '_discount_deduct_{}'.format(currency.lower()))
            db.delete_column('shop_discountcode', '_discount_exact_{}'.format(currency.lower()))
    ...
    models = {
        ...
        'shop.discountcode': {
            ...
            '_min_purchase_aud': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
            '_min_purchase_nzd': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
