...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Product.first_published_date'
        db.add_column('shop_product', 'first_published_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Product.first_published_date'
        db.delete_column('shop_product', 'first_published_date')
