...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProductSyncRequest'
        db.create_table('shop_productsyncrequest', (
            ('product', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['shop.Product'], unique=True, primary_key=True)),
        ))
        db.send_create_signal('shop', ['ProductSyncRequest'])

    def backwards(self, orm):
        # Deleting model 'ProductSyncRequest'
        db.delete_table('shop_productsyncrequest')
