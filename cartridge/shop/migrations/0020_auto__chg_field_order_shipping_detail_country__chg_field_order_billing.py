...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Product.sync_images'
        db.add_column('shop_product', 'sync_images',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.date_images_last_synced'
        db.add_column('shop_product', 'date_images_last_synced',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'Product.sync_stock'
        db.add_column('shop_product', 'sync_stock',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Product.date_stock_last_synced'
        db.add_column('shop_product', 'date_stock_last_synced',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)
