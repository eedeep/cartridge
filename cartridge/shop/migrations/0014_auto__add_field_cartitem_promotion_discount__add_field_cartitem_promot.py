...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Product._available_colours'
        db.delete_column('shop_product', '_available_colours')

        # Deleting field 'Product._available_sizes'
        db.delete_column('shop_product', '_available_sizes')

        # Adding field 'Product.product_colours'
        db.add_column('shop_product', 'product_colours',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Product.product_sizes'
        db.add_column('shop_product', 'product_sizes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Adding field 'Product._available_colours'
        db.add_column('shop_product', '_available_colours',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'Product._available_sizes'
        db.add_column('shop_product', '_available_sizes',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Deleting field 'Product.product_colours'
        db.delete_column('shop_product', 'product_colours')

        # Deleting field 'Product.product_sizes'
        db.delete_column('shop_product', 'product_sizes')
    ...
    models = {
        ...
        'shop.cartitem': {
            ...
            'promotion_description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'promotion_discount': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '2', 'blank': 'True'}),
        ...
        'shop.product': {
            ...
            'product_colours': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
