...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CartItem.promotion_discount'
        db.delete_column('shop_cartitem', 'promotion_discount')

        # Deleting field 'CartItem.promotion_description'
        db.delete_column('shop_cartitem', 'promotion_description')


        # Changing field 'Product.product_colours'
        db.alter_column('shop_product', 'product_colours', self.gf('django.db.models.fields.CharField')(max_length=500))
    def backwards(self, orm):
        # Adding field 'CartItem.promotion_discount'
        db.add_column('shop_cartitem', 'promotion_discount',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=12, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'CartItem.promotion_description'
        db.add_column('shop_cartitem', 'promotion_description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Product.product_colours'
        db.alter_column('shop_product', 'product_colours', self.gf('django.db.models.fields.CharField')(max_length=255))
    models = {
