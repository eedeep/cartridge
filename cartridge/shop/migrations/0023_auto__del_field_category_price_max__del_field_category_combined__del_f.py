...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('shop_category', 'price_max',
        ...
        db.add_column('shop_category', 'combined',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Category.sale'
        db.add_column('shop_category', 'sale',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['shop.Sale'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Category.price_min'
        db.add_column('shop_category', 'price_min',
                      self.gf('cartridge.shop.fields.MoneyField')(null=True, max_digits=10, decimal_places=2, blank=True),
                      keep_default=False)
