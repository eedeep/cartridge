...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'TagFacet', fields ['slug']
        db.delete_unique('taggit_tagfacet', ['slug'])

    def backwards(self, orm):
        # Adding unique constraint on 'TagFacet', fields ['slug']
        db.create_unique('taggit_tagfacet', ['slug'])
